...
vim.keymap.set('n', '<leader>t', require('nvim-tree.api').tree.toggle, { desc = '[T]ree toggle' })
-- Next/Previous buffer with alt + left/right arrow
...
local servers = {
  ...
  pylsp = {
    pylsp = {
      plugins = {
        pycodestyle = {
          ignore = {'E501', 'E115', 'E266', 'E265', 'W191', 'E305', 'E722'},
        },
